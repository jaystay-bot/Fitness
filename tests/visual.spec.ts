...
//   2. document.body backgroundColor === rgb(10, 11, 13)   (locked ink)
//   3. Primary CTA backgroundColor === rgb(182, 242, 74)   (locked lime)
//
...
const EXPECTED_BODY_BG = "rgb(10, 11, 13)";
const EXPECTED_CTA_BG = "rgb(182, 242, 74)";
